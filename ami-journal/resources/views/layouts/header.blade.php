<div class="container" data-aos="fade" data-aos-duration="1000" data-aos-once="true">
    <header>
        <div class="row">
            ...
            <div class="col-xl-2" style="text-align: right;"><a href="{{ asset('login') }}" class="btn btn-primary" role="button" style="margin-top: 2vw;--bs-primary: #004863;--bs-primary-rgb: 0,72,99;background: rgb(0,72,99);">Login</a></div>
        </div>
    </header>
</div>
